 ...
 * un-pruning in an EJB container against a MySql database using List 
 * oriented Entities.
 * <p>
 ...
 */
public class EntityUtilMysqlEjbListTest extends AbstractGlassFishContainerTest {
     ...
     */
    public EntityUtilMysqlEjbListTest() {
        super();
